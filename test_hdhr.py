...
if len(devices) > 0:
    try:
        ...
        print('Tuner 2 lockkey owner:  {}').format(devices[0].get_tuner_lockkey_owner())
        print('Tuner 2 vchannel:  {}').format(devices[0].get_var(item='/tuner2/vchannel'))
        print('Tuner 2 channel:  {}').format(devices[0].get_var(item='/tuner2/channel'))
        print('Tuner 2 channelmap: {}').format(devices[0].get_var(item='/tuner2/channelmap'))
        ...
        print('Failure: {}'.format(str(sd_error)))
